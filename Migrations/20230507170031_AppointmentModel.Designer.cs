...
namespace ValenciaBot.Migrations
{
    ...
    [Migration("20230507170031_AppointmentModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ValenciaBot.Data.Entities.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<DateTime>("PreferredBookingDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("ValenciaBot.Data.Entities.ClinicOperatingHour", b =>
                {
                    ...
                    b.Property<string>("DaysDescription")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ValenciaBot.Data.Entities.Messages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ValenciaBot.Data.Entities.Appointment", b =>
                {
                    b.HasOne("ValenciaBot.Data.Entities.User", "ConfirmedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("ValenciaBot.Data.Entities.Messages", b =>
                {
                    b.HasOne("ValenciaBot.Data.Entities.Conversation", null)
                        .WithMany("Messages")
